...
def main():
    ...
    parser.add_argument("-i", "--max_iterations", type=int, default=10, help="perform n iterations")
    ...
    optimizer.set_algorithm(g2o.OptimizationAlgorithmLevenberg(g2o.BlockSolverX(g2o.LinearSolverEigenX())))
